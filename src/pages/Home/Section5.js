...
import StorageGoogle from "../../assets/shop/googleplay.png";
        ...
        <Container>
            <Row className='align-items-center'>
                <Col lg={6} className='text-center text-lg-start mb-5 mb-lg-0'>
                    ...
                    <Link>
                        <img src={StorageGoogle} alt="IOS" className='img-fluid store me-3'/>
                    </Link>
                </Col>
                <Col lg={6}>
                    ...
                    <Carousel.Item>
                        <Carousel.Caption>
                            <div className='d-flex align-items-center justify-content-between'>
                                ...
                                <div className='brand_img'>
                                    <img src={Brand6} className='img-fluid' alt="brannd6"/>
                                </div>
                                <div className='brand_img'>
